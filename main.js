...
// If BSC_CHAIN_ID is defined in config.js, this line will be overridden.
// Otherwise, it acts as a fallback.
const BSC_CHAIN_ID = typeof window.BSC_CHAIN_ID !== 'undefined' ? window.BSC_CHAIN_ID : '0x38';
...
async function connectWallet() {
  ...
  try {
    ...
    // **ตรวจสอบว่าตัวแปรเหล่านี้ถูกโหลดและมีอยู่จาก config.js**
    // (ใช้ typeof window.variableName เพื่อตรวจสอบตัวแปร global ที่มาจากไฟล์อื่น)
    ...
    loadStakingInfo();
    loadReferralInfo(); // เรียก loadReferralInfo() เพื่อโหลดข้อมูลค่าแนะนำ
