...
// const usdtAddress = "..."
// const routerAddress = "..."
// const BSC_CHAIN_ID = "..." (ถ้าเลือกใส่ใน config.js)
...
// If BSC_CHAIN_ID is defined in config.js, remove this line.
...
async function connectWallet() {
  ...
  try {
    ...
    // **สำคัญมาก:** ตรวจสอบว่าตัวแปรเหล่านี้ถูกโหลดและมีอยู่จาก config.js
    // หาก 'contractAddress' หรือ 'stakingABI' หรืออื่นๆ ไม่ถูกประกาศใน config.js
    // หรือมีการสะกดชื่อผิด จะทำให้เกิด ReferenceError ตรงนี้
    if (typeof contractAddress === 'undefined' || typeof stakingABI === 'undefined' ||
        ...
        (typeof BSC_CHAIN_ID === 'undefined' && typeof window.BSC_CHAIN_ID === 'undefined')) { // ตรวจสอบ BSC_CHAIN_ID ด้วย
...
async function loadStakingInfo() {
  ...
  try {
    ...
    document.getElementById("stakeAmount").classList.add("error"); // Add error class
  }
}
...
async function loadReferralInfo() {
  ...
  try {
    ...
    document.getElementById("referralRewardAmount").classList.add("error"); // Add error class
  }
}
...
window.addEventListener('load', () => {
  ...
  // ตรวจสอบให้แน่ใจว่า ID ของปุ่มใน HTML ตรงกับที่นี่
