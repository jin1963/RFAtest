...
// *** บรรทัดนี้ถูกลบออกไปแล้วใน config.js ดังนั้นไม่ต้องประกาศซ้ำที่นี่ ***
...
async function connectWallet() {
  ...
  try {
    ...
    // ใช้ BSC_CHAIN_ID ที่มาจาก config.js โดยตรง
    ...
    if (typeof window.contractAddress === 'undefined' || typeof window.stakingABI === 'undefined' ||
        ...
        typeof window.BSC_CHAIN_ID === 'undefined') { // ตรวจสอบ BSC_CHAIN_ID ว่ามาจาก config.js หรือไม่
